#!/usr/bin/env python3
"""その152 (キュー 1) — RR-CMA-ES（de Nobel+ 2024）を D=20 で回す。

**その127 の `run_rrcma.py` を `git show dceb6c7^:analysis/mmo2024/e127/run_rrcma.py` で
取り出し、出力先を `e149/dumps` に変えただけ**（その132 の統合で e127 は削除済み）。
...
使い方: python3 analysis/mmo2024/e127/run_rrcma.py <problem> [seed] [budget]
"""
...
OUT = HERE / "dumps"  # e152/dumps（その127 は e127/dumps、その149 は e149/dumps）
